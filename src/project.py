...
try:
    ...
    print("Warning: NLTK not found or failed to load. Text processing may be limited.")
    stop_words = set()
...
def save_plots(results):
    ...
    print("Plots saved to project_output_*.png")
...
def main():
    print("\n--- Course Recommendation System (Project Mode) ---")
    print("1. Voice Input")
    print("2. PDF Upload")
    print("3. Text Input")
    ...
    # Filter columns that verify exist
    ...
    # Save to file
    with open("project_results.txt", "w", encoding="utf-8") as f:
        f.write(results.to_string(index=False))
    print("\nFull results saved to project_results.txt")
